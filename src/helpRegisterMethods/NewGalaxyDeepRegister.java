...
public class NewGalaxyDeepRegister {
	...
	public void setUp() throws Exception {
		...
		baseUrl = "test1.ykhazran.d.ukrtech.info";
	...
	public void test5Register() throws Exception {
		...
		while (i < n) {
			...
			*/
			...
			driver.manage().deleteAllCookies();
			sponsor_login_sample = i + sponsor_login_sample;
			i++;
		}
	}
